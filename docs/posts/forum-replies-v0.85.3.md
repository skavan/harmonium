...
Thanks for this report — all three items are addressed in v0.85.3, and your
...
activity, Controller tab, and set the Now Playing style — v0.85.3 adds
...
page should say 0.85.3), then **open the Studio and press Save & Deploy
...
Studio is what quietly repaired it). v0.85.3 generates the starter from the
...
browser cache if the remote looks unchanged (ⓘ should say 0.85.3), then
