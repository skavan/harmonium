...
Restart Home Assistant after updating — this release changes the integration, not just the remote files. On first load the Studio will modernize older control spellings and slim down untouched generated sequences; both are reported in the status line and touch nothing you edited by hand. Colors are entirely opt-in: nothing changes on your remotes until you pick an accent.
