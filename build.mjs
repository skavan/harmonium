...
const SCRIPTS = [
  ...
  "core/context.js",       // activity scope + $context resolution
  "core/generators.js",    // expandTile: apps/keys/devices/volumes/presets/groups
  "core/gen-browse.js",    // the browse generator (library surface)
  "core/gen-browse-amalgam.js", // ★ Favorites merge + ♫ de-mirrored library
  "core/gen-browse-search.js",  // the search grid (results, chips, states)
  "core/subscribe.js",     // entitiesFor → subscribe_entities → applyDiff
  "core/activities.js",    // activity lifecycle, presets, actions
  "core/routing.js",       // brRoute + provenance badges (pure functions)
  "core/browse.js",        // browse state, tree fetch, the bar (bands 1+2)
  "core/sonos-index.js",   // phase-3 local index: crawl, cache, fuzzy match
  "core/search.js",        // query line, engines (index/MA/generic), keyboard
  "core/queue.js",         // per-platform queue adapters + queue: screen
  "core/keycap.js",        // key-capture virtual screen (keys:)
  "core/diag.js",          // diagnostics virtual screen (diag:) — ⓘ tap
  ...
  "ui/tiles.js",           // the tile CHASSIS: slots, badges, spans, fitting
  "ui/render.js",          // banner/hero, navigate, renderStates, the bar
