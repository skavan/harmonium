# Harmonium — project history (v0.82.1 and earlier)

The older half of [`docs/PROJECT.md`](../../docs/PROJECT.md)'s
changelog, split out in the 2026-08-17 cleanup so the living
document stays readable. Same format: newest first, decisions
inline, nothing rewritten.
